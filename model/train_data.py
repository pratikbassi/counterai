...
def discover_train_test_real_fake(dataset_path: Path, max_depth: int = 6) -> Optional[dict]:
    ...
    # Ensure both labels exist in both splits.
    ...
    split_root = train_dir.parent if train_dir.parent == test_dir.parent else dataset_path
    return {
...
def build_train_val_datasets(
    ...
    *,
    ...
    if split_data is not None:
        ...
        train_ds = RealFakePathsDataset(split_data["train_items"], transform=train_tfms)
        val_ds = RealFakePathsDataset(split_data["val_items"], transform=eval_tfms)
